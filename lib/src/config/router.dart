...
class HomeScreen extends ConsumerWidget {
  ...
  String _initialsFromProfile(String displayName, String email) {
    final normalizedName = displayName.trim();
    if (normalizedName.isNotEmpty && normalizedName != 'Người dùng') {
            ...
            child: Row(
              ...
              children: [
                CircleAvatar(
                  ...
                  child: photoUrl == null
                      ? Text(
                          _initialsFromProfile(displayName, email),
                          style: TextStyle(
                            fontWeight: FontWeight.w700,
                            color: scheme.onPrimaryContainer,
                          ),
